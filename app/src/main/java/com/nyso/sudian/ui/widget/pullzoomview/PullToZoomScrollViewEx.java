package com.nyso.sudian.ui.widget.pullzoomview;
...
//                            + mRootView.getScrollY();
    ...
    public void setScrollContentView(View contentView) {
        Log.d(TAG, "setScrollContentView" );
        if (contentView != null) {
    ...
    public void handleStyledAttributes(TypedArray a) {
        Log.d(TAG, "handleStyledAttributes --> ");
