...
public class ProxyDrawable extends Drawable {
    ...
    public ProxyDrawable(View view) {
        ...
        indicatorWidth=(int) view.getContext().getResources().getDimension(com.ahtrun.mytablayout.R.dimen.indicator_width);
        this.view = view;
        paint = new Paint();
...
//        }
        ...
        int mTop= (int) view.getContext().getResources().getDimension(R.dimen.padding9dp);
        int radius = (int) view.getContext().getResources().getDimension(R.dimen.padding1dp);
        if (mIndicatorLeft >= 0 && mIndicatorRight > mIndicatorLeft) {
            canvas.drawRoundRect(new RectF(mIndicatorLeft+margin, height - mTop-mSelectedIndicatorHeight,
                    mIndicatorRight-margin, height-mTop), radius, radius, paint);
        }
    }
